...
enum Changelog {
    ...
    static let entries: [ChangelogEntry] = [
        ChangelogEntry(
            ...
            changes: [
                "Doses remaining is now based on your last dose, not an average. If you\u{2019}re titrating up, the estimate reflects where you actually are \u{2014} and the vial detail shows exactly which dose size it\u{2019}s using."
            ]
        ),
        ChangelogEntry(
            version: "1.10.0",
        ...
        ChangelogEntry(
            ...
            changes: [
                "History's injection-site map now uses the same athletic silhouette as the Body tab — one consistent figure across the app."
            ]
        ),
        ChangelogEntry(
            version: "1.8.0",
            ...
            date: date("2026-04-19"),
            changes: [
                "The Body tab now opens directly to the silhouette. The List layout has been retired — every metric is reachable by tapping its marker or the Weight/Body fat pills."
            ]
        ),
        ChangelogEntry(
            version: "1.7.1",
