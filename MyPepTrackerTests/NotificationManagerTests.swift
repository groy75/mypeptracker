...
struct NotificationManagerTests {
    ...
    @Test func nextDoseDateForFixedRecurringWithLastDoseAndTimeAlignment() {
        ...
        let lastDose = calendar.date(from: DateComponents(year: 2024, month: 1, day: 8, hour: 9, minute: 0))!
        ...
        // Last dose Jan 8 + 1 day = Jan 9, aligned to 08:00
        let expected = calendar.date(from: DateComponents(year: 2024, month: 1, day: 9, hour: 8, minute: 0))!
        #expect(next == expected)
    }
