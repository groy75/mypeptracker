...
| 1.9.0     | 13    | 2026-04-30      | **TestFlight** | New vial form shows an orange warning banner until both peptide amount and water volume are explicitly changed from defaults, preventing the common mistake of saving 5mg/2mL defaults for a vial that was actually mixed differently. Banner auto-dismisses once both fields are touched. Delivery UUID `3240fbba-2c2d-4acb-b938-492a3f07eb22`. **TestFlight-only**. |
